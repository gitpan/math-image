...
use App::MathImage::Values::Sequence::Undulating;
...

{
  ...
  ok (eval { App::MathImage::Values::Sequence::Undulating->VERSION($want_version); 1 },
      "VERSION class check $want_version");
  my $check_version = $want_version + 1000;
  ok (! eval { App::MathImage::Values::Sequence::Undulating->VERSION($check_version); 1 },
...
{
  my $hi = 13000;
  my $values_obj = App::MathImage::Values::Sequence::Undulating->new
    (lo => 1,
     hi => $hi);
  my @next = (0) x ($hi+1);
