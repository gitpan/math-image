...

{
  ...
  ok (eval { Math::PlanePath::MathImageQuintetCurve->VERSION($want_version); 1 },
      1,
      "VERSION class check $want_version");
  my $check_version = $want_version + 1000;
  ok (! eval { Math::PlanePath::MathImageQuintetCurve->VERSION($check_version); 1 },
      1,
...

{
  ...
  foreach my $elem (@data) {
    my ($arms, $n, $x, $y) = @$elem;
    my $path = Math::PlanePath::MathImageQuintetCurve->new (arms => $arms);
    {
      # n_to_xy()
