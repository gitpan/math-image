...
# math-image --path=MathImageQuintetSide --lines --scale=10
# math-image --path=MathImageQuintetSide --output=numbers


package Math::PlanePath::MathImageQuintetSide;
use 5.004;
use strict;
use List::Util 'max';
use POSIX 'ceil';
...
=item C<$path = Math::PlanePath::MathImageQuintetSide-E<gt>new ()>
