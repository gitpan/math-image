...
# math-image --path=MathImageCrossSide --lines --scale=10
# math-image --path=MathImageCrossSide --output=numbers


package Math::PlanePath::MathImageCrossSide;
use 5.004;
use strict;
...
Math::PlanePath::MathImageCrossSide -- one side of the crosses fill

=head1 SYNOPSIS

 use Math::PlanePath::MathImageCrossSide;
...
=item C<$path = Math::PlanePath::MathImageCrossSide-E<gt>new ()>
