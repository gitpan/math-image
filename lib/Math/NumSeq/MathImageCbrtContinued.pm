...
package Math::NumSeq::MathImageCbrtContinued;
use 5.004;
use strict;
...
sub next {
  ...
  if ($p > 0) {
    die "Oops, MathImageCbrtContinued poly not negative";
  }
...
Math::NumSeq::MathImageCbrtContinued -- continued fraction expansion of a cube root

=head1 SYNOPSIS

 use Math::NumSeq::MathImageCbrtContinued;
 my $seq = Math::NumSeq::MathImageCbrtContinued->new (cbrt => 2);
 my ($i, $value) = $seq->next;
...
=item C<$seq = Math::NumSeq::MathImageCbrtContinued-E<gt>new (cbrt =E<gt> $s)>
