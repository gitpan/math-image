...
package App::MathImage::NumSeq::Sequence::Expression;
use 5.004;
use strict;
use warnings;
use Carp;
...
{
  package App::MathImage::NumSeq::Sequence::Expression::LanguageExpr;
...
sub new {
  ...
  if ($evaluator eq 'MS') {
    ...
    my @vars = grep {
      do {
        no strict;
        ! defined ${"App::MathImage::NumSeq::Sequence::Expression::LanguageExpr::$_"}
      }
    } @$varef;
    if (@vars > 1) {
    ...
    $subr = eval "package App::MathImage::NumSeq::Sequence::Expression::LanguageExpr;
                  use strict;
