...
package App::MathImage::NumSeq::RadixWithoutDigit;
use 5.004;
use strict;
...
# in TernaryWithout2 ... # OEIS-Catalogue: A005836 radix=3 digit=2  # base 3 no 2
...
# in Base4without3 ... # OEIS-Catalogue: A023717 radix=4 digit=3  # base 4 no 3
