...
package App::MathImage::NumSeq::Cubes;
use 5.004;
use strict;
use Math::Libm 'cbrt';
...
App::MathImage::NumSeq::Cubes -- cubes i^3

=head1 SYNOPSIS

 use App::MathImage::NumSeq::Cubes;
 my $seq = App::MathImage::NumSeq::Cubes->new;
 my ($i, $value) = $seq->next;
...
=item C<$seq = App::MathImage::NumSeq::Cubes-E<gt>new (key=E<gt>value,...)>
