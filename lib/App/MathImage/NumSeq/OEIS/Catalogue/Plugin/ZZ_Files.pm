...
package App::MathImage::NumSeq::OEIS::Catalogue::Plugin::ZZ_Files;
use 5.004;
use strict;
use File::Spec;
use App::MathImage::NumSeq::OEIS::File;
...
sub _make_info {
  ...
  ### _make_info(): $anum
  return { anum => $anum,
           class => 'App::MathImage::NumSeq::OEIS::File',
...
sub anum_to_info {
  ...
  my $dir = App::MathImage::NumSeq::OEIS::File::oeis_dir();
  foreach my $basename
    ("$anum.internal",
     "$anum.html",
     "$anum.htm",
     App::MathImage::NumSeq::OEIS::File::anum_to_bfile($anum),
     App::MathImage::NumSeq::OEIS::File::anum_to_bfile($anum,'a')) {
