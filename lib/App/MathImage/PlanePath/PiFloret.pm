...
package App::MathImage::PlanePath::PiFloret;
use 5.004;
use strict;
use warnings;
...
=for stopwords Pi PlanePaths PiFloret fibonacci sqrt PlanePath Ryde Math-PlanePath

=head1 NAME

App::MathImage::PlanePath::PiFloret -- circular spiral like a sunflower

=head1 SYNOPSIS

 use App::MathImage::PlanePath::PiFloret;
 my $path = App::MathImage::PlanePath::PiFloret->new;
 my ($x, $y) = $path->n_to_xy (123);

=head1 DESCRIPTION

The Pi spiral arranges integer points in a spiraling pattern so they
...
Most of the other PlanePaths are implicitly quadratic, but the PiFloret
...
=item C<$path = App::MathImage::PlanePath::PiFloret-E<gt>new ()>
