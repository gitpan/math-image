...
package App::MathImage::Values::OeisCatalogue::Plugin::ZZ_Files;
use 5.004;
use strict;
use File::Spec;
use App::MathImage::Values::Sequence::OEIS::File;
...
sub _make_info {
  ...
  ### _make_info(): $anum
  return { anum => $anum,
           class => 'App::MathImage::Values::Sequence::OEIS::File',
...
sub anum_to_info {
  ...
  my $dir = App::MathImage::Values::Sequence::OEIS::File::oeis_dir();
  foreach my $basename
    ("$anum.internal",
     "$anum.html",
     "$anum.htm",
     App::MathImage::Values::Sequence::OEIS::File::anum_to_bfile($anum),
     App::MathImage::Values::Sequence::OEIS::File::anum_to_bfile($anum,'a')) {
