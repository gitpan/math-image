...
package App::MathImage::Values::Sequence::Squares;
use 5.004;
use strict;
use POSIX 'ceil';
use List::Util 'max';
...
App::MathImage::Values::Sequence::Squares -- perfect squares
...
=item C<$seq = App::MathImage::Values::Sequence::Squares-E<gt>new (key=E<gt>value,...)>
...
L<App::MathImage::Values::Sequence::Cubes>
