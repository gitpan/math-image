...
package App::MathImage::Values::Sequence::ProthNumbers;
use 5.004;
use strict;
...
=item C<$seq = App::MathImage::Values::Sequence::ProthNumbers-E<gt>new()>
...
Return true if C<$value> is a Proth number.
...
L<App::MathImage::Values::Sequence::CullenNumbers>,
L<App::MathImage::Values::Sequence::WoodallNumbers>
