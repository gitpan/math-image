...
package App::MathImage::Values::Sequence::DigitCountHigh;
use 5.004;
use strict;
...
use App::MathImage::Values::Sequence::DigitCount;
*parameter_list = \&App::MathImage::Values::Sequence::DigitCount::parameter_list;
