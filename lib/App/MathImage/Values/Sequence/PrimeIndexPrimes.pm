...
package App::MathImage::Values::Sequence::PrimeIndexPrimes;
use 5.004;
use strict;
use List::Util 'min', 'max';
use POSIX ();

use App::MathImage::Values::Sequence::Primes;
...
sub new {
  ...
  my @array = App::MathImage::Values::Sequence::Primes::_my_primes_list ($lo, $hi);
  my $primes = \@array;
  foreach (1 .. $level) {
    my $i = 0;
