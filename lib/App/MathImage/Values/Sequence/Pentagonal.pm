...
package App::MathImage::Values::Sequence::Pentagonal;
use 5.004;
use strict;

use App::MathImage::Values::Base '__';
use base 'App::MathImage::Values::Sequence::Polygonal';
...
use constant parameter_list => (App::MathImage::Values::Sequence->parameter_common_pairs);
