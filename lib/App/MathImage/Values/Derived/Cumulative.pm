...
package App::MathImage::Values::Derived::Cumulative;
use 5.004;
use strict;
use POSIX 'ceil';
use List::Util 'max';
...
App::MathImage::Values::Derived::Cumulative -- cumulative sum of a sequence

=head1 SYNOPSIS

 use App::MathImage::Values::Derived::Cumulative;
 my $seq = App::MathImage::Values::Derived::Cumulative->new
